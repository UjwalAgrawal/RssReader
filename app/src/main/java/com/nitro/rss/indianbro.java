...
public class indianbro extends AppCompatActivity {
    ListView lv;
    ArrayList<dis> dis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indianbro);
        Toolbar toolbar = (Toolbar) findViewById(R.id.brotool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Indians In Abroad");
        lv= (ListView) findViewById(R.id.indianbrolist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.indbrofresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(indianbro.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvnews-indians-abroad");
