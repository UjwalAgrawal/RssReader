...
public class latest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.lattool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Latest Feed");
        lv= (ListView) findViewById(R.id.latestlist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.latfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(latest.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvnews-latest");
