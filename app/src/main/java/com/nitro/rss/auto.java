...
public class auto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.autoanim);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Automotive News Feed");
        lv= (ListView) findViewById(R.id.autolist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.autofresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(auto.this);
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/carandbike-latest");
