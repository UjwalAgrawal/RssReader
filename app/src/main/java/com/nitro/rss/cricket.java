...
public class cricket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.crictool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Cricket News Feed");
        lv= (ListView) findViewById(R.id.cricklist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.cricfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(cricket.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvsports-cricket");
