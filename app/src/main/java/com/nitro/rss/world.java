...
public class world extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.worldtool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("World News Feed");
        lv= (ListView) findViewById(R.id.worldlist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.worlfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(world.this);
        @Override
