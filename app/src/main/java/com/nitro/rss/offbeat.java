...
public class offbeat extends AppCompatActivity {
    ListView lv;
    ArrayList<dis> dis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offbeat);
        Toolbar toolbar = (Toolbar) findViewById(R.id.offtool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Off Beat News Feed");
        lv= (ListView) findViewById(R.id.offlist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.offfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(offbeat.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvnews-offbeat-news");
