...
public class business extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.busitool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Business News Feed");
        lv= (ListView) findViewById(R.id.busilist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.busifresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(business.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvprofit-latest");
