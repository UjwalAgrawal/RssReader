...
public class people extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.peptool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("People's News Feed");
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.pepfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(people.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvnews-people");
