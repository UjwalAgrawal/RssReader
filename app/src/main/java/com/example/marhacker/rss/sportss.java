...
public class sportss extends AppCompatActivity {
    ListView lv;
    ArrayList<dis> dis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sportss);
        Toolbar toolbar = (Toolbar) findViewById(R.id.spotool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Sports Feed");
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.spofresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(sportss.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvsports-latest");
