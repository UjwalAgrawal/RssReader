...
public class india extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.indtool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Indian News Feed");
        lv= (ListView) findViewById(R.id.indialis);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.indfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(india.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvnews-india-news");
