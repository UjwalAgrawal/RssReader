...
public class hindi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.hintool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("हिंदी समाचार");
        lv= (ListView) findViewById(R.id.hindilist);
        ...
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.hinfresh);
    ...
    public class ProcessInBackground extends AsyncTask<Integer, Void, Exception> {
        ...
        ProgressDialog pd = new ProgressDialog(hindi.this);
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try {
                ...
                URL url = new URL("http://feeds.feedburner.com/ndtvkhabar-latest");
